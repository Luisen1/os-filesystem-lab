...
### Refactor
- **ui**: remove emojis and improve professional appearance ([91accdb](https://github.com/Luisen1/os-filesystem-lab/commit/91accdb))
  - Remove all emoji characters from JournalingAnalysis component
  - Replace emoji indicators with text-based alternatives
  - Improve visual hierarchy without decorative elements
  - Make design more professional and academic-oriented
...
### Documentation
- manually generate complete CHANGELOG with all commits ([9d83d60](https://github.com/Luisen1/os-filesystem-lab/commit/9d83d60))
